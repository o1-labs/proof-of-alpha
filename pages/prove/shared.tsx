...
const Shared: NextPage = () => {
  return (
    <Layout
      ...
      layoutStyle="relative h-2.25*screen min-h-fit 2xl:h-1.75*screen"
    >
      ...
      <Container containerStyle="">
        <div className="mt-3 flex flex-col justify-between md:mt-0 md:flex-row">
          ...
          <div className="3xl:mt-86  mt-14 md:mt-64">
            <div className="3xl:mb-28 mb-20 flex flex-col items-center 2xl:mb-20">
              <p className="3xl:text-lg text-[.6em] leading-5 tracking-widest md:text-xs md:leading-none md:tracking-wide xl:text-sm">
            ...
            <div className="3xl:space-y-3 flex flex-col items-center space-y-2 2xl:space-y-1 ">
              ...
              <p className="3xl:text-base text-[.55em] md:text-xs 2xl:text-sm">
      ...
      <div className="3xl:h-1/4 absolute  bottom-0 mt-20 h-80  w-full bg-[#79797940]   md:h-1/6 lg:h-52  xl:h-72 2xl:h-1/4">
        <div className="3xl:space-y-8 flex h-full  flex-col items-center justify-center space-y-5  2xl:space-y-9 ">
          ...
          <p className="2xl:text-1.5xl 3xl:text-3xl 3xl:pb-3 w-7/12 pb-3 text-center text-base tracking-widest md:w-full ">
