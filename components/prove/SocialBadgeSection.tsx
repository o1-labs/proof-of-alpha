...
const SocialBadgeSection = () => {
  ...
  return (
    <Layout backGroundColor="grayGradient">
      ...
      <div className="3xl:h-[320px] absolute bottom-0 h-[170px]  w-full bg-[#79797940] 2xl:h-2/6">
        <div className="flex flex-col  items-center  ">
          <div className="3xl:w-3/12 3xl:space-y-10  flex w-4/12 flex-col items-center justify-center space-y-4 2xl:w-3/12 2xl:space-y-9 ">
            <div className=" 3xl:w-auto 2xl:mt-18 3xl:mt-10  mt-5 w-14 2xl:w-28">
