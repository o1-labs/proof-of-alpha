...
const TradeHistorySection = () => {
  return (
    <div className="flex h-screen bg-background bg-cover bg-no-repeat">
      <header className="">
        <div className="ml-36 mt-5 items-center w-20   md:ml-10  md:mt-12  md:h-32 md:w-auto absolute">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center h-screen mt-30 md:mt-40 md:ml-52 ">
        <div className="container w-10/12 md:w-auto h-screen flex flex-col space-y-6 md:space-y-8    text-white ">
          <p className="text-xl md:text-7xl text-white w-full">
            Your Trade History Sets You Apart
          </p>
          <div className="flex flex-col px-3 md:px-0 space-y-6 md:space-y-8 ">
            <p className="text-base md:text-4xl font-light  text-white">
