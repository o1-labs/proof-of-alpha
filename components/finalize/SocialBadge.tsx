...
const ReturnsAndTradeBadge = () => {
  return (
    <div className="2xl:full flex w-9/12 xl:w-11/12 flex-col items-center justify-center">
      ...
      <div className="3xl:w-10/12 3xl:mb-30  w-9/12 2xl:mb-24 2xl:-mt-2 2xl:w-full xl:w-full ">
