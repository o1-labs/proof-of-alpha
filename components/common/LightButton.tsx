  ...
  return (
    <button
      className={`${
       ...
       active:bg-black-500  w-full items-center  justify-center border-1/2 border-x-gray-400 py-2  text-xs  leading-normal hover:bg-opacity-75  focus:bg-[#254298] focus:text-white 2xl:py-4 2xl:text-xl ${lightButtonStyle}`}
      {...otherProps}
    >
      {label}
    </button>
